<template>
    <div class="footer">
      <div class="column">
        ...
        <div class="payment-partners">
          ...
          />
          <img
            alt="Payment Partner 2"
            height="40"
            src="@/assets/Images/cake.png" 
            width="60"
          />
          <img
            alt="Payment Partner 3"
            height="40"
            src="@/assets/Images/cake.png" 
            width="60"
          />
      ...
      <div class="column">
        ...
        <div class="app-links">
          ...
          <img
            alt="Apple App Store"
            height="40"
            src="@/assets/Images/AppStore1.png" 
            width="120"
          />
        </div>
      </div>
  ...
  color: white; /* Đặt màu chữ là trắng */
   ...
   .footer {
        ...
        display: flex;
        flex-wrap: wrap; /* Cho phép hình ảnh nằm trên nhiều dòng */
        justify-content: flex-start; /* Hoặc dùng space-between để có khoảng cách đều */
    }
