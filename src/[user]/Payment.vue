                    ...
                    <div class="p-4">
                        ...
                        <div class="mb-4">
                            <div class="flex items-center mb-2">
                                <input type="radio" id="vietqr" name="payment" class="mr-2 cursor-pointer"
                                    v-model="selectPayment" value="vietqr" />
                        ...
                        <div class="mb-4">
                            <div class="flex items-center mb-2">
                                <input type="radio" id="credit-card" name="payment" class="mr-2 cursor-pointer"
                                    v-model="selectPayment" value="credit-card" />
                        ...
                        <div class="mb-4">
                            <div class="flex items-center mb-2">
                                <input type="radio" id="payment_momo" name="payment_momo" v-model="selectPayment"
                                    value="transfer" class="mr-2 cursor-pointer" />
                                <label for="store">Thanh toán với ATM momo</label>
                            </div>
                        </div>
                        <div class="mb-4">
                            <div class="flex items-center mb-2">
                                <input type="radio" id="store" name="payment_cash" class="mr-2 cursor-pointer"
                                    v-model="selectPayment" value="cash" />
                                <label for="store">Tại điểm du lịch</label>
                            </div>
                            <div v-if="selectPayment === 'cash'"
                                class="border border-blue-500 p-4 rounded-lg bg-blue-50">
                                <ul class="list-disc pl-5 text-sm">
                                    <li>
                                        Đảm bảo bạn có ví điện tử hoặc ứng dụng ngân hàng di động hỗ
                        ...
                        <div class="mb-4">
                            ...
                            <div class="p-4 bg-white rounded-lg shadow-md">
                                <div class="flex justify-between items-center mb-4">
                                    ...
                                    <span class="font-semibold text-gray-800 text-lg">722.850 VND</span>
                                </div>
                                <button
