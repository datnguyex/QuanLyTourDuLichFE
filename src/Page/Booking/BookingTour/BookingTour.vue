            ...
            <p>Error: {{ errorValue }}</p>
                ...
                <div class="bg-gray-100 p-4 rounded-lg mb-6">
                  ...
                  <div class="mb-4">
                    ...
                    <input v-model="nameContact" class="w-full p-2 border rounded" placeholder="Họ và tên" type="text"/>
          ...
          <div class="ml-20 max-w-lg bg-white p-6 rounded-lg shadow-md mb-6">
            ...
            <div class="border p-4 rounded-lg">
              ...
              <div class="mb-4">
                ...
                <input v-model="nameCustomer" class="block w-full border border-gray-300 rounded-lg p-2.5" type="text" value=""/>
              ...
              <div class="flex space-x-4 mb-4">
                <div class="flex-1">
                  ...
                  <input v-model="emailCustomer" class="block w-full border border-gray-300 rounded-lg p-2.5" type="text" value=""/>
                  <p class="text-sm text-gray-500 mt-1">
            ...
            <div class="border rounded-lg">
              ...
              <div class="p-4">
                ...
                <div class="flex justify-between">
                  ...
                  <span>
                      {{ formatPrice(valueTour?.price_children * numChildren || 0) }} VND
                  </span>
                </div>
              </div>
            </div>
