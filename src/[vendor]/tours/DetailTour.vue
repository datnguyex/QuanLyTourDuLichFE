      ...
      <form class="form_tour" v-if="swicth == ''" @submit.prevent="handleSubmit">
        ...
        <div class="form-group">
          ...
          <div class="image_tours" v-if="imagePreviews.length">
            <img class="image_tours-item" v-for="(image, index) in imagePreviews" :key="index" :src="image" alt="Image"
              width="100" />
          </div>
          <img src="http://127.0.0.1:8000/storage/images/7B9dDErH16ywJWIhieXV9sRYitUb0dC5qNgJ0jCo.png" alt="Tour Image"
            width="100" />
